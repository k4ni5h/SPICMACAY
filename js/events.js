var allevents=[
	...
	},
	{
		...
		artists:[],
		detail:"A quiz is being organized for the students of the college on 'Heritage India'.",
		artist_come:"",
		event_start:"",
		anchor:[],
		proceedings:[],
	...
	{
		topic:"Collage Making Event",
		date:"14 Jan 2018",
		time:"2:00 PM",
		venue:"ABN Ground",
		artists:[],
		detail:"To explore the students’ creativity and imagination along with improving their presentation skills. To encourage students to take part in different competitions. To provide a platform to the students to explore and experiment so that they can come up with innovative ideas. Collage making is a very interesting branch of art in which the poster is made by pasting the unused /discarded pieces of papers/magazines with the help of gum on paper. The themes of collage making is 'Women Empowerment'.",
		artist_come:"",
		event_start:"",
		anchor:[],
		proceedings:[],
	...
	{
		topic:"Cinema Classic 'Natsamrat'",
		date:"13 Jan 2018",
		time:"5:30 PM",
		venue:"Bose Auditorium",
		artists:[],
		detail:"Natsamrāt (roughly translated as: The King of Theater or The Actor King) is a 2016 Indian Marathi-language drama film starring Nana Patekar in the leading role. The film depicts the life of a stage actor who has retired from acting but is unable to forget his fond memories of theatre and the stage. It is one of highest grossing Marathi movie with an IDMB rating of 9.3.",
		artist_come:"",
		event_start:"",
		anchor:[],
		proceedings:[],
	},
	{
		...
		time:"6:15 PM",
		venue:"DoMS Hall",
		artists:["Debopriya Chatterjee", "Suchismita Chatterjee"],
		detail:"Flute Sisters - Suchismita & Debopriya Chatterjee are the only performing women flautists in Hindustani Classical Music and have been trained by the living God of flute, Padma Vibhushan Pandit Hariprasad Chaurasia. They received their initial training in flute under the guidance of Late Pandit Bholanath Prasanna. They were honored as Sur Mani at the Kal Ke Kalakar conference in 2001. They have also been featured performers at Swami Haridas Sangeet Sammelan, a noted Indian classical music conference.They have been bestowed with awards like Ustad Bismillah Khan Yuva Puraskar from Sangeet Natak Akademi, and the Sahara Excellence Award to name a few.",
		artist_come:"",
		event_start:"",
		anchor:[],
		proceedings:[],
