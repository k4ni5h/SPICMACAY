var student={
  ...
  2:[['Kanish','kanish'],['Tanpreet Singh Kalsi','tanpreet'],['Sakshi Priya','sakshi'],['Samarth Gubrele','gubrele'],['Nipun Pruthi','nipun'],['Kapil Birthala','jaipur'],['Vishal Purohit','vishal'],['Bharat Joshi','bharat'],['Pratyush Jha','jha'],['Sneha Maheshwari','mahishmati'],['Shazeb Ata','shazeb'],['An Var Ali','anvar'],['Mohit Aneja','mohit'],['Sourab Yadav','sourab'],['Naman Gupta','naman'],['Anirudh Garg','anirudh'],['Vaibhav Nayer','vaibhav2']],
  1:[]
};
